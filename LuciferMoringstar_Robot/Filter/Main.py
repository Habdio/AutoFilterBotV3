...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Making', url=f'{https://t.me/+o0magU0LHq5jZmQ9}')
                ]
                ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ How To Own 🖥️ Join Channel', url=f'{https://t.me/+o0magU0LHq5jZmQ9}')
                    ]
                    ]
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                await query.answer("ഒന്നു wait ചെയ്യടോ ഞാൻ നോക്കട്ടെ 😒",show_alert=True)
                return
            ident, file_id = query.data.split("#")
            filedetails = await get_file_details(file_id)
            for files in filedetails:
